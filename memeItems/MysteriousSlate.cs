...
{
	// Magic Mirror is one of the only vanilla memeItems that does its action somewhere other than the start of its animation, which is why we use code in UseStyle NOT UseItem.
	// It may prove a useful guide for ModmemeItems with similar behaviors.
	class MysteriousSlate : ModItem
	{
		public override string Texture
		{
			get { return "Terraria/Item_" + ItemID.MagicMirror; }
		}
