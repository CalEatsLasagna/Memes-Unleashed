...
{
	public class FlamarangGun : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Shoots out Flamarangs.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.autoReuse = true;
			item.shoot = ProjectileID.Flamarang;
			item.shootSpeed = 16f;
		}
			public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			for (int i = 0; i < numberProjectiles; i++)
			{
				Vector2 perturbedSpeed = new Vector2(speedX, speedY).RotatedByRandom(MathHelper.ToRadians(20)); // 20 degree spread.
				 ...
				 Projectile.NewProjectile(position.X, position.Y, perturbedSpeed.X, perturbedSpeed.Y, ProjectileID.Flamarang, damage, knockBack, player.whoAmI);
			}
			return false;
		}
		...
		// What if I wanted this gun to have a 12% chance not to consume ammo?
