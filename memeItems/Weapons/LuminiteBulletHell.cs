...
{
	public class LuminiteBulletHell : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("77% chance not to consume ammo."
								+ "\nNow with even more hell.");
		}
		...
		{
			int numberProjectiles = 16 + Main.rand.Next(2); // way too many shots
