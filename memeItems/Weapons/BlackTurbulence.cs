...
{
	public class BlackTurbulence : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("The Ambassador's hand.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = mod.ProjectileType("NullBullet");
			item.shootSpeed = 20f;
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			Projectile.NewProjectile(position.X, position.Y, speedX, speedY, mod.ProjectileType("NullSphere"), damage, knockBack, player.whoAmI);
