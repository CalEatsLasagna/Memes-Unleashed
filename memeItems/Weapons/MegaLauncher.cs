...
{
	public class MegaLauncher : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Unleashes very powerful blasts of pure energy.");
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "CompressedStatic", 20);
			recipe.AddIngredient(null, "SpacialShard", 10);
			recipe.AddIngredient(null, "StaticLauncher");
