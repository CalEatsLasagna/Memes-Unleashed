...
namespace MemesUnleashed.memeItems.Weapons
{
	public class Luna : ModItem
	{
		...
		{
			Tooltip.SetDefault("77% chance to not consume ammo.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.autoReuse = true;
			item.shoot = mod.ProjectileType("LunaShot"); 
			item.shootSpeed = 16f;
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			for (int i = 0; i < numberProjectiles; i++)
			{
				...
				Projectile.NewProjectile(position.X, position.Y, perturbedSpeed.X, perturbedSpeed.Y, mod.ProjectileType("LunaShot"), damage, knockBack, player.whoAmI);
			}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "MemeCoin", 300);
