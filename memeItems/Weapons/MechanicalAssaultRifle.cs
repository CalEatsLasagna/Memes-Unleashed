...
{
	public class MechanicalAssaultRifle : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Imbued with mechanical power.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.value = 11200;
			item.rare = 3;
			item.UseSound = mod.GetLegacySoundSlot(SoundType.Custom, "Sounds/Custom/Laser");
			item.autoReuse = true;
			item.shoot = 10;
			item.shootSpeed = 26f;
