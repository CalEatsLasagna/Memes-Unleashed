...
{
	public class OrangeSodagun : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Caffeine!");
		}
		...
		public override void SetDefaults()
		{
			...
			item.autoReuse = true;
			item.shoot = mod.ProjectileType("OrangeBubble"); //idk why but all the guns in the vanilla source have this
			item.shootSpeed = 10f;
		}
