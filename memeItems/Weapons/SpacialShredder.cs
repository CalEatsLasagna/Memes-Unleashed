...
{
	public class SpacialShredder : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Rip through your enemies.");
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "SpacialShard", 45);
			recipe.AddIngredient(null, "NullBlaster");
