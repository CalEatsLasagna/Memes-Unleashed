...
{
	public class PharaohsCatharsis : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Pharaoh's Catharsis");
			Tooltip.SetDefault("A cursed bow from times of old.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.autoReuse = true;
			item.shoot = mod.ProjectileType ("PharaohsHand"); //idk why but all the guns in the vanilla source have this
			item.shootSpeed = 37f;
				...
				public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			for (int i = 0; i < numberProjectiles; i++)
			{
				...
				Projectile.NewProjectile(position.X, position.Y, perturbedSpeed.X, perturbedSpeed.Y, mod.ProjectileType ("PharaohsHand"), damage, knockBack, player.whoAmI);
			}
		...
		public override void AddRecipes()
		{
			...
			recipe3.AddIngredient(ItemID.SandstoneBrick, 20);
			recipe3.AddIngredient(ItemID.GoldBar, 10);
			recipe3.AddIngredient(ItemID.TendonBow);
			recipe3.AddTile(null, "Compressor");
			recipe3.SetResult(this);
			recipe3.AddRecipe();
			
			ModRecipe recipe2 = new ModRecipe(mod);
			recipe2.AddIngredient(ItemID.SandstoneBrick, 20);
			recipe2.AddIngredient(ItemID.PlatinumBar, 10);
			recipe2.AddIngredient(ItemID.DemonBow);
			recipe2.AddTile(null, "Compressor");
			recipe2.SetResult(this);
			recipe2.AddRecipe();
			
			ModRecipe recipe4 = new ModRecipe(mod);
			recipe4.AddIngredient(ItemID.SandstoneBrick, 20);
			recipe4.AddIngredient(ItemID.PlatinumBar, 10);
			recipe4.AddIngredient(ItemID.TendonBow);
			recipe4.AddTile(null, "Compressor");
