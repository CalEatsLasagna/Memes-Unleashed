...
{
	public class BlueBit : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Available only for a limited time. Can be used to craft special items in a future update!");
		}
		public override void SetDefaults()
		{
			...
			// RecipeGroups allow you create a recipe that accepts memeItems from a group of similar ingredients. For example, all varieties of Wood are in the vanilla "Wood" Group
