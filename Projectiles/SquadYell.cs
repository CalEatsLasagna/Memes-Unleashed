...
{
	public class SquadYell : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Squad Yell");     //The English name of the projectile
		...
		{
			projectile.width = 58;               //The width of projectile hitbox
		...
		public override void Kill(int timeLeft)
		{
			...
			Main.PlaySound(mod.GetLegacySoundSlot(SoundType.Custom, "Sounds/Custom/SquadYell"), projectile.position);
		}
