...
{
	public class IronThrowingKnifeProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Iron Throwing Knife");
		}
		...
		public override void Kill(int timeLeft)
		{
			...
			int item =
				Main.rand.Next(66) == 0
					? Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType<IronThrowingKnife>())
					: 0;
