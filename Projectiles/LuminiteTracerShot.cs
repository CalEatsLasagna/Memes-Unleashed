...
{
	public class LuminiteTracerShot : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Luminite Tracer Shot");     //The English name of the projectile
		...
		for(int i = 0; i < 200; i++)
			{
...

				{
					...
					//If the distance between the live targeted npc and the projectile is less than 200 pixels
					if(distance < 200f && !target.friendly && target.active)
						{
