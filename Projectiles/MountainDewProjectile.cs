...
{
	public class MountainDewProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("MountainDew");
		}
		...
		public override void Kill(int timeLeft)
		{
			...
			// Drop a javelin item, 32% chance
			int item =
				Main.rand.Next(32) == 0
					? Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType<MountainDew>())
					: 0;
