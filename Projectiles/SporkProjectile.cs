...
{
	public class SporkProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Spork");
		}
		...
		public override void Kill(int timeLeft)
		{
			...
			// Drop a javelin item, 23% chance
			int item =
				Main.rand.Next(23) == 0
					? Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType<Spork>())
					: 0;
		...
		public override void AI()
		{
			...
			if (isStickingToTarget)
			{
				...
				// Every 10 ticks, the javelin will perform a hit effect
				hitEffect = projectile.localAI[0] % 10f == 0f;
