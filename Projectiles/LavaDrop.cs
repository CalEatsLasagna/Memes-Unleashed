...
namespace MemesUnleashed.Projectiles
{
	public class LavaDrop : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, mod.DustType("MagmaDust"), projectile.oldVelocity.X * 2f, projectile.oldVelocity.Y * 2f);
		}
	}
}