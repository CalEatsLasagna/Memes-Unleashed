...
{
	public class SodaSplash : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Soda Splash");
		}
		...
		public override void AI()
		{
			...
			if (!isStickingToTarget)
			{
				...
				if (targetWhoAmI >= maxTicks)
				{
					...
					float velXmult = 1.05f; // x velocity factor, every AI update the x velocity will be 98% of the original speed
					float
						velYmult = 1.55f; // y velocity factor, every AI update the y velocity will be be 0.35f bigger of the original speed, causing the javelin to drop to the ground
				...
				{
					Dust dust = Dust.NewDustDirect(projectile.position, projectile.height, projectile.width, mod.DustType<Dusts.Swirl>(),
			...
			if (isStickingToTarget)
			{
				...
				projectile.ignoreWater = false; // Make sure the projectile ignores water
