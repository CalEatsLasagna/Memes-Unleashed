...
{
	public class DemonThrowingKnifeProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Demon Throwing Knife");
		}
		...
		public override void Kill(int timeLeft)
		{
			...
			int item =
				Main.rand.Next(66) == 0
					? Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType<DemonThrowingKnife>())
					: 0;
