...
{
	public class RedGumdropProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Red Gumdrop");     //The English name of the projectile
				...
				public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, mod.DustType("MagmaDust"), projectile.velocity.X * 1f, projectile.velocity.Y * 1.2f);
		}
	}
}
