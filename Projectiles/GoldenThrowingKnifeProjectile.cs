...
{
	public class GoldenThrowingKnifeProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Golden Throwing Knife");
		}
		...
		public override void Kill(int timeLeft)
		{
			...
			// Drop a javelin item, 66% chance
			int item =
				Main.rand.Next(66) == 0
					? Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType<GoldenThrowingKnife>())
					: 0;
