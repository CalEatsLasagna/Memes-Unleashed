...
namespace MemesUnleashed.Projectiles
{
	public class LunarOrb : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Lunar Orb");     //The English name of the projectile
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, mod.DustType("Null"), projectile.velocity.X * 1.2f, projectile.velocity.Y * 1f);
		}
	}
}
