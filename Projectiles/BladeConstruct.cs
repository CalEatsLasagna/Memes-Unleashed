...
{
	public class BladeConstruct : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Blade Construct");
		}
		...
		public override void AI()
		{
			...
			if (!isStickingToTarget)
			{
				...
				if (targetWhoAmI >= maxTicks)
				{
					...
					float
						velYmult = 1.35f; // y velocity factor, every AI update the y velocity will be be 0.35f bigger of the original speed, causing the javelin to drop to the ground
				...
				{
					Dust dust = Dust.NewDustDirect(projectile.position, projectile.height, projectile.width, mod.DustType<Dusts.WaterDust>(),
